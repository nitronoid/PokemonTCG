...
public :
  ...
  //----------------------------------------------------------------------------------------------------------------------
  virtual void effectUsed() override;
  //----------------------------------------------------------------------------------------------------------------------
  /// @brief interface for executing when a card is played
  //----------------------------------------------------------------------------------------------------------------------
  virtual void playCard(const PTCG::PILE, Card*const) override;
  //----------------------------------------------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------------------------------------------------
  virtual void moveCard(const PTCG::PILE, const PTCG::PILE,  Card*const) override;
  //----------------------------------------------------------------------------------------------------------------------
